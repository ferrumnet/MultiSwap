...
// Configuration: Replace with your contract's details and node provider URL
const contractAddress = '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1';
const providerUrl = 'wss://arb-mainnet.g.alchemy.com/v2/YHUv6Z37N4tkOnzgfg9YAzrv6BKG76ar'; // e.g., Infura, Alchemy URL for the Ethereum Testnet
...
async function init() {
    ...
    provider.on("block", async (log) => {
        console.log(`Block Number: ${log}`);
    })
}
...
process.on('SIGINT', () => {
    console.log('SIGINT received. Closing all WebSockets.');
    provider.removeAllListeners();
    provider.destroy();

    setTimeout(() => process.exit(0), 1000); // Delay to allow for cleanup
});