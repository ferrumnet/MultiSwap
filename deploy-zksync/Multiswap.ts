...
const deployScript = async function (hre: HardhatRuntimeEnvironment) {
    ...
    // await sendTx(fundManager.setLiquidityManagers(deployerAddress, addresses.liquidityManagerBot), "setLiquidityManagers successful")
    ...
    amount = "1000000"
    // await sendTx(forgeManager.setLiquidityManagers(deployerAddress, addresses.liquidityManagerBot), "setLiquidityManagers successful")
    // // await sendTx(usdc.approve(forgeManager, MaxUint256), "Approve successful")
    await sendTx(forgeManager.addLiquidityByManager(foundry, BigInt(amount)), "addLiquidity successful")
